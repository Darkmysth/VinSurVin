...
class SampleData {
    ...
    var croixDeLAngeMillesime2005: Millesime!
    var bouteillesCroixDeLAngeMillesime2005: Bouteille!
    ...
    private func insertSampleData(in context: ModelContext) {
        ...
        self.troisToitsMillesime2024 = troisToitsMillesime2024
        ...
        self.lafiteRothschildMillesime1999 = lafiteRothschildMillesime1999
        // Création et insertion des bouteilles
        let bouteillesTroisToitsMillesime2024 = Bouteille.sampleBouteillesTroisToitsMillesime2024(millesime: troisToitsMillesime2024, taille: taille)
        context.insert(bouteillesTroisToitsMillesime2024)
        self.bouteillesTroisToitsMillesime2024 = bouteillesTroisToitsMillesime2024
        let bouteillesLafiteRothschildMillesime1999 = Bouteille.sampleBouteillesLafiteRothschildMillesime1999(millesime: lafiteRothschildMillesime1999, taille: taille)
        context.insert(bouteillesLafiteRothschildMillesime1999)
        self.bouteillesLafiteRothschildMillesime1999 = bouteillesLafiteRothschildMillesime1999
